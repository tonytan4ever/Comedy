...
import itertools
import uuid
from pycassa.cassandra.ttypes import (Column, ColumnOrSuperColumn, ColumnParent,
...
class RowDefaults(object):
    ...
    def asCfDef(cls):
        ...
        cfdef = CfDef(keyspace=cls._keyspace.name, name=cls._column_family, column_type=cls._column_type, 
                      ...
                      row_cache_size=cls._row_cache_size, #preload_row_cache=cls._preload_row_cache, 
                      key_cache_size=cls._key_cache_size,
                      )
        return cfdef
